...
function createWindow() {
    ...
    mainWindow = new BrowserWindow({
        ...
        resizable: false,
        alwaysOnTop: true,
        useContentSize: false // when false, width/height will set the size of the whole app, including frames. If true, innerWindow will be set instead, resulting in a bigger app window
    })
